...
var main = (function(){
    ...
    function Product(name, price, expDate){
        ...
        this.getInfo = function(){
            return this.name[0].toUpperCase()+ this.name[this.name.length-1].toUpperCase() + this.id + ", " + this.name + ", " + this.price.toFixed(2)
        }
...
//////////////////////////////////
    function checkOutAndBuy (bag,card){
        ...
        if(this.cardBalance>this.price){
            ...
            return ((price - cardBalance).toFixed(2)) + "$ is missing to complete the purchase"
        }
